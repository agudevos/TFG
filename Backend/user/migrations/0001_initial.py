    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default='a@gmail.com', max_length=254, unique=True)),
                ('name', models.CharField(default='a', max_length=75)),
                ('surname', models.CharField(default='a', max_length=75)),
                ('phone_number', models.PositiveIntegerField(default=123456789, validators=[django.core.validators.RegexValidator('^[0-9]{6}', message='El número de teléfono debe contener solo dígitos y una longitud de 6 dígitos.')])),
